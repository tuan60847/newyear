...
function checkVerification() {
    var inputCode = document.getElementById("DateOfBirth").value;
    var correctCode = "21072001"; // Mã xác nhận đúng

    if (inputCode === correctCode) {
        // Nếu mã nhập vào đúng, chuyển hướng đến trang mới
        window.location.href = "./heart.html";
    } else {
        alert("Bạn Không phải là người đó òi Xin Lỗi Vì đã vô tình vào web nhé ");
    }
}
